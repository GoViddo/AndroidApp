...
public class RegistrationActivity extends AppCompatActivity {
    ...
    EditText mEditTextFirstName, mEditTextLastName, mEditTextEmail, mEditTextPassword, mEditTextBirthDate;
    Button mBtnRegister;

    public static String mFirstName, mLastName, mEmailAddress, mPassword, mCountryName;
    ...
    TextInputLayout mTextInputLayoutFirstName, mTextInputLayoutLastName, mTextInputLayoutEmail,
            mTextInputLayoutCountryName, mTextInputLayoutGender,mTextInputLayoutPassword, mTextInputLayoutBirthDate;
   ...
   SpinnerDialog spinnerDialog;
    ...
    private boolean checkPassword() {
        if (mPassword.trim().isEmpty() || mPassword.length() < 7){
            mTextInputLayoutPassword.setErrorEnabled(true);
            mTextInputLayoutPassword.setError("Please Enter Password Greater Than 7 Characters");
            return false;
        }
        mTextInputLayoutPassword.setErrorEnabled(false);
        return true;
